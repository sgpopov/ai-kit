...
# Copies all reference markdown files in the repository to ~/.claude/agents,
...
# If ~/.claude/agents is a symlink that resolves into this repo, we'd end up
# copying files back into the repo's own agents/ tree. Detect and bail out
